...
import net.alek.succorstadiums.item.custom.FlintCharmItem;
...
public class ModItems {
    ...
    public static final TagKey<Item> REPAIRS_FLINT_CHARM = TagKey.create(BuiltInRegistries.ITEM.key(), Identifier.fromNamespaceAndPath(SuccorStadiums.MOD_ID, "repairs_flint_charm"));
    public static final ToolMaterial FLINT_CHARM_TOOL_MATERIAL = new ToolMaterial(
            BlockTags.INCORRECT_FOR_WOODEN_TOOL,
            64,
            0F,
            -1F,
    ...
    public static final Item FLINT_CHARM = registerItem("flint_charm", properties -> FlintCharmItem(properties.attributes()))
