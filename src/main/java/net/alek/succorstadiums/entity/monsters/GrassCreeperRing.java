...
public class GrassCreeperRing extends AreaEffectCloud {

    private static final DustParticleOptions GREEN_DUST = new DustParticleOptions(0x2E8B57, 1.3F);

    private static final float INNER_RADIUS = (float) GrassCreeper.ATTACK_RADIUS;
    ...
    private static final float RING_JITTER = (OUTER_RADIUS - INNER_RADIUS) / 2.0F;
    ...
    public GrassCreeperRing(Level level, double x, double y, double z) {
        super(level, x, y, z);
