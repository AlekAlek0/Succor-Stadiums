...
public class ModConsumeEffects {
    ...
    public static final ConsumeEffect.Type<RestoreManaConsumeEffect> RESTORE_MANA_TYPE =
            new ConsumeEffect.Type<>(RestoreManaConsumeEffect.CODEC, RestoreManaConsumeEffect.STREAM_CODEC);
    ...
    public static void registerModConsumeEffects() {
        ...
        Registry.register(
                BuiltInRegistries.CONSUME_EFFECT_TYPE,
                Identifier.fromNamespaceAndPath(SuccorStadiums.MOD_ID, "restore_mana"),
                RESTORE_MANA_TYPE
        );
